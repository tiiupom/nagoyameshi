...
public class AdminCategoryController {
			...
			Model model)
	{
		...
		if (keyword != null && !keyword.isEmpty()) {
			...
			categoryPage = categoryService.findAllgetCategories(pageable);
		}
						 ...
						 Model model)
	{
		...
		categoryService.createCategories(categoryRegisterForm);
						 ...
						 Model model)
	{
		...
		categoryService.updateCategories(categoryEditForm, category);
		redirectAttributes.addFlashAttribute("successMessage", "カテゴリの編集内容を保存しました");
